...
public class PublicRentalController {
  ...
  @ApiErrorCodeExamples({ErrorCode.NOT_FOUND_ITEM, ErrorCode.NOT_FOUND_ITEM_UNIT, ErrorCode.ILLEGAL_BORROWER_LABEL, ErrorCode.NOT_FOUND_PHONE_VERIFICATION_TOKEN, ErrorCode.PHONE_VERIFICATION_TOKEN_MISMATCH, ErrorCode.PHONE_VERIFICATION_PURPOSE_MISMATCH, ErrorCode.EXPIRED_PHONE_VERIFICATION_TOKEN, ErrorCode.BORROW_EMAIL_VERIFICATION_TOKEN_NOT_FOUND, ErrorCode.BORROW_EMAIL_VERIFICATION_TOKEN_MISMATCH, ErrorCode.BORROW_EMAIL_VERIFICATION_TOKEN_EXPIRED})
