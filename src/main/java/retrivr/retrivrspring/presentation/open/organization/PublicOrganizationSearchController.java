...
public class PublicOrganizationSearchController {
  ...
  public OrganizationSearchPageResponse searchRankedPageByKeyword(
    ...
    return publicOrganizationSearchService.searchRankedPageByKeyword(keyword, cursor, size);
  }
  ...
  public List<String> getSearchSuggestions(
    ...
    return publicOrganizationSearchService.getSuggestions(keyword, size);
  }
}
