...
public record EmailCodeVerifyTokenResponse(
    ...
    public static EmailCodeVerifyTokenResponse borrowToken(String token, int expiresInSeconds) {
        return new EmailCodeVerifyTokenResponse("BORROW", token, expiresInSeconds);
    }
}
