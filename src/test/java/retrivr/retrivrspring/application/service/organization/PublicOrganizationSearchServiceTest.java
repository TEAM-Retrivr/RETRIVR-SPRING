...
class PublicOrganizationSearchServiceTest {
  ...
  void search_firstPage_hasNext_true() {
    ...
    OrganizationSearchPageResponse res =
        publicOrganizationSearchService.searchRankedPageByKeyword(keyword, cursor, size);
  ...
  void search_firstPage_hasNext_false() {
    ...
    // when
    OrganizationSearchPageResponse res =
        publicOrganizationSearchService.searchRankedPageByKeyword(keyword, null, size);
  ...
  void suggestions_keyword_null() {
    // when
    List<String> res = publicOrganizationSearchService.getSuggestions(null, 10);
  ...
  void suggestions_keyword_too_short() {
    // when
    List<String> res = publicOrganizationSearchService.getSuggestions(" a ", 10);
  ...
  void suggestions_ok() {
    ...
    // when
    List<String> res = publicOrganizationSearchService.getSuggestions("ab", 3);
